...
//pull first_name & last_name & concatinate. Need to iterate through the entire array and recall that index starts at 0.
...
runners.forEach(item => allCaps.push(item.first_name.toUpperCase()));
console.log(allCaps);
...
let ticketPriceTotal = runners.reduce((acc, item) => {
